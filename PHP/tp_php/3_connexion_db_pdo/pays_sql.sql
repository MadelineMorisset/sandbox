...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 12 juil. 2024 à 11:00
...
--
CREATE DATABASE IF NOT EXISTS `pays` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `pays`;
...
(354, 'Chine - Macao', '', '118', '', 593, 11, 5, 81, 4, 1, 15, 57, 4, 8),
